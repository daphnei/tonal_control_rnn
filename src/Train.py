...
def main():
    ...
    parser.add_argument('--harmony_dir', type=str, default='data',
                        help='data directory containing input harmony midi files')
    parser.add_argument('--melody_dir', type=str, default='data',
                        help='data directory containing input melody midi files')
...
def train(args):
    music_loader_melody = MusicLoader(args.melody_dir, args.batch_size, args.seq_length)
